...
import type { ArbitrumV3Types } from './sources/arbitrum-v3/types';
...
export type MeshContext = ArbitrumV3Types.Context & BaseMeshContext;
...
const importFn: ImportFn = <T>(moduleId: string) => {
  ...
  switch(relativeModuleId) {
    case ".graphclient/sources/arbitrum-v3/introspectionSchema":
      return import("./sources/arbitrum-v3/introspectionSchema") as T;
...
const arbitrumV3Transforms = [];
const additionalTypeDefs = [] as any[];
const arbitrumV3Handler = new GraphqlHandler({
              name: "arbitrum-v3",
              config: {"endpoint":"https://api.thegraph.com/subgraphs/name/aave/protocol-v3-arbitrum","timeout":5000,"retry":2},
              baseDir,
              cache,
              pubsub,
              store: sourcesStore.child("arbitrum-v3"),
              logger: logger.child("arbitrum-v3"),
              importFn,
            });
arbitrumV3Transforms[0] = new BlockTrackingTransform({
                  apiName: "arbitrum-v3",
...
sources[0] = {
          name: 'arbitrum-v3',
          handler: arbitrumV3Handler,
          transforms: arbitrumV3Transforms
        }
