...
import type { PolygonV3Types } from './sources/Polygon V3/types';
...
export type MeshContext = PolygonV3Types.Context & BaseMeshContext;
...
const importFn: ImportFn = <T>(moduleId: string) => {
  ...
  switch(relativeModuleId) {
    case ".graphclient/sources/Polygon V3/introspectionSchema":
      return import("./sources/Polygon V3/introspectionSchema") as T;
...
const polygonV3Transforms = [];
const additionalTypeDefs = [] as any[];
const polygonV3Handler = new GraphqlHandler({
              name: "Polygon V3",
              config: {"endpoint":"https://api.thegraph.com/subgraphs/name/aave/protocol-v3-polygon","timeout":5000,"retry":2},
              baseDir,
              cache,
              pubsub,
              store: sourcesStore.child("Polygon V3"),
              logger: logger.child("Polygon V3"),
              importFn,
            });
polygonV3Transforms[0] = new BlockTrackingTransform({
                  apiName: "Polygon V3",
...
sources[0] = {
          name: 'Polygon V3',
          handler: polygonV3Handler,
          transforms: polygonV3Transforms
        }
