...
import type { OptimismV3Types } from './sources/optimism-v3/types';
...
export type MeshContext = OptimismV3Types.Context & BaseMeshContext;
...
const importFn: ImportFn = <T>(moduleId: string) => {
  ...
  switch(relativeModuleId) {
    case ".graphclient/sources/optimism-v3/introspectionSchema":
      return import("./sources/optimism-v3/introspectionSchema") as T;
...
const optimismV3Transforms = [];
const additionalTypeDefs = [] as any[];
const optimismV3Handler = new GraphqlHandler({
              name: "optimism-v3",
              config: {"endpoint":"https://api.thegraph.com/subgraphs/name/aave/protocol-v3-optimism","timeout":5000,"retry":2},
              baseDir,
              cache,
              pubsub,
              store: sourcesStore.child("optimism-v3"),
              logger: logger.child("optimism-v3"),
              importFn,
            });
optimismV3Transforms[0] = new BlockTrackingTransform({
                  apiName: "optimism-v3",
...
sources[0] = {
          name: 'optimism-v3',
          handler: optimismV3Handler,
          transforms: optimismV3Transforms
        }
