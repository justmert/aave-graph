...
import type { AvalancheV3Types } from './sources/avalanche-v3/types';
...
export type MeshContext = AvalancheV3Types.Context & BaseMeshContext;
...
const importFn: ImportFn = <T>(moduleId: string) => {
  ...
  switch(relativeModuleId) {
    case ".graphclient/sources/avalanche-v3/introspectionSchema":
      return import("./sources/avalanche-v3/introspectionSchema") as T;
...
const avalancheV3Handler = new GraphqlHandler({
              ...
              cache,
              pubsub,
              store: sourcesStore.child("avalanche-v3"),
...
sources[0] = {
          ...
          transforms: avalancheV3Transforms
        }
