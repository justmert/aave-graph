...
import type { HarmonyV3Types } from './sources/harmony-v3/types';
...
export type MeshContext = HarmonyV3Types.Context & BaseMeshContext;
...
const importFn: ImportFn = <T>(moduleId: string) => {
  ...
  switch(relativeModuleId) {
    case ".graphclient/sources/harmony-v3/introspectionSchema":
      return import("./sources/harmony-v3/introspectionSchema") as T;
...
const harmonyV3Transforms = [];
const additionalTypeDefs = [] as any[];
const harmonyV3Handler = new GraphqlHandler({
              name: "harmony-v3",
              config: {"endpoint":"https://api.thegraph.com/subgraphs/name/aave/protocol-v3-harmony","timeout":5000,"retry":2},
              baseDir,
              cache,
              pubsub,
              store: sourcesStore.child("harmony-v3"),
              logger: logger.child("harmony-v3"),
              importFn,
            });
harmonyV3Transforms[0] = new BlockTrackingTransform({
                  apiName: "harmony-v3",
...
sources[0] = {
          name: 'harmony-v3',
          handler: harmonyV3Handler,
          transforms: harmonyV3Transforms
        }
