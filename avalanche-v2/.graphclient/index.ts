...
import type { AvalancheV2Types } from './sources/avalanche-v2/types';
...
export type MeshContext = AvalancheV2Types.Context & BaseMeshContext;
...
const importFn: ImportFn = <T>(moduleId: string) => {
  ...
  switch(relativeModuleId) {
    case ".graphclient/sources/avalanche-v2/introspectionSchema":
      return import("./sources/avalanche-v2/introspectionSchema") as T;
...
const avalancheV2Handler = new GraphqlHandler({
              ...
              cache,
              pubsub,
              store: sourcesStore.child("avalanche-v2"),
...
sources[0] = {
          ...
          transforms: avalancheV2Transforms
        }
