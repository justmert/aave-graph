...
import type { PolygonV2Types } from './sources/polygon-v2/types';
...
export type MeshContext = PolygonV2Types.Context & BaseMeshContext;
...
const importFn: ImportFn = <T>(moduleId: string) => {
  ...
  switch(relativeModuleId) {
    case ".graphclient/sources/polygon-v2/introspectionSchema":
      return import("./sources/polygon-v2/introspectionSchema") as T;
...
const polygonV2Handler = new GraphqlHandler({
              ...
              cache,
              pubsub,
              store: sourcesStore.child("polygon-v2"),
...
sources[0] = {
          ...
          transforms: polygonV2Transforms
        }
